...
import (
	...
	"github.com/yarencheng/crypto-trade/go/exchange/poloniex"
...
func main() {
	...
	err := ctx.AddConfigs(&v1.List{
		...
		ID:        "poloniex",
		Type:      v1.T(poloniex.Poloniex{}),
		FactoryFn: poloniex.New,
		...
		Properties: []v1.Property{
			{
				...
				Name:   "Path",
				Config: v1.V("poloniex.order.sqlite"),
			},
		},
	}, &v1.Channel{
		ID:   "orders",
	...
	_, err = ctx.GetByID("poloniex")
	if err != nil {
		logger.Fatalf("Failed to get poloniex. err: [%v]", err)
	}
